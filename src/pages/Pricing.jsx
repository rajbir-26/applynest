    ...
    <div className="min-h-screen bg-paper text-neutral-dark flex flex-col justify-between antialiased relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen justify-between">
        <div>
          ...
          <main className="max-w-4xl mx-auto px-6 py-6 text-center animate-fade-up">
            ...
            <div className="max-w-md mx-auto bg-white/90 backdrop-blur-sm border-2 border-[#944E2D] rounded-2xl p-5 shadow-md relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              <Link
                to="/jobs"
                className="block w-full bg-[#944E2D] hover:bg-[#7D3F22] text-white text-xs font-bold py-2.5 rounded-xl transition-all active:scale-95 shadow-sm text-center"
              >
            ...
            <div className="mt-6 max-w-md mx-auto bg-[#F9F6F0]/90 backdrop-blur-sm border border-[#EAD9C9] rounded-2xl p-4 shadow-sm transition-all duration-300 hover:shadow-md">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2.5">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-[11px] px-3 py-2 rounded-lg transition-all active:scale-95 shadow-sm"
                >
                  <span>💬</span> WhatsApp
                </a>
                ...
                <a
                  href="#"
                  onClick={(e) => e.preventDefault()}
                  className="inline-flex items-center gap-1.5 bg-gradient-to-r from-purple-600 via-pink-600 to-amber-500 hover:opacity-90 text-white font-bold text-[11px] px-3 py-2 rounded-lg transition-all active:scale-95 shadow-sm"
                >
                  <span>📸</span> Instagram
                </a>
                ...
                <a
                  href="#"
                  onClick={(e) => e.preventDefault()}
                  className="inline-flex items-center gap-1.5 bg-red-600 hover:bg-red-700 text-white font-bold text-[11px] px-3 py-2 rounded-lg transition-all active:scale-95 shadow-sm"
                >
                  <span>▶️</span> YouTube
                </a>
              </div>

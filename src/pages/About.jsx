...
export default function About() {
      ...
      <div>
        ...
        <main className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-white border border-[#EAD9C9] rounded-2xl p-6 shadow-sm">
  ...
  <p className="text-xs text-gray-600 leading-relaxed font-medium">
    Unlike traditional job portals that are cluttered with social media noise, hidden paywalls, or endless application loops, ApplyNest cuts straight to what matters: verified roles, zero fluff, and direct application links.
          ...
          <div className="bg-[#F9F6F0] border border-[#EAD9C9] rounded-3xl p-8 mb-16 text-center max-w-3xl mx-auto shadow-sm">
          ...
          {/* Goals Section */}
          <div className="bg-white border-2 border-[#944E2D] rounded-3xl p-8 shadow-md">
